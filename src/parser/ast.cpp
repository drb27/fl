...
objref classdef_node::evaluate(context* pContext)
{
    ...
    listref paramList = std::dynamic_pointer_cast<list_object>(_derive_list->evaluate(pContext));
...
void classdef_node::required_symbols(std::set<std::string>& s) const
{
...
void classdef_node::direct_subordinates( std::list<ast*>& s) const
{
